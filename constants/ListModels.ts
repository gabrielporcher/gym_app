    ...
    weeklyWorkout: [
      {
        icon: "A",
        title: "A 1",
        description: "Tap to assign exercises",
        tags: ["Customizable"],
      },
      {
        icon: "B",
...
export const exercisesList: ExerciseTemplate[] = [
  ...
  },
  {
    ...
    title: "Plank",
    agonistMuscle: "Abs",
    synergistMuscles: ["Back", "Shoulders"],
    muscleIntensity: [
      {
        muscle: "Abs",
        intensity: "moderate",
